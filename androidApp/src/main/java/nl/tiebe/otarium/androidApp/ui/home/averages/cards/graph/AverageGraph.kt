package nl.tiebe.otarium.androidApp.ui.home.averages.cards.graph
...
internal fun AverageGraph(grades: List<GradeWithGradeInfo>, manualGrades: List<ManualGrade>) {
    ElevatedCard(
        ...
        Text(
            text = stringResource(MR.strings.graph.resourceId),
        ...
        val gradeText = stringResource(MR.strings.grade.resourceId)
        val averageText = stringResource(MR.strings.average.resourceId)
