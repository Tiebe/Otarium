...
internal fun AddGradeManually(component: AveragesComponent, subject: Subject) {
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(MR.strings.manual_name.resourceId)) },
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(MR.strings.manual_grade.resourceId)) },
            modifier = Modifier.weight(1f)
        )
        ...
        OutlinedTextField(
            ...
            singleLine = true,
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Decimal),
            label = { Text(stringResource(MR.strings.manual_weight.resourceId)) },
            modifier = Modifier.weight(1f)
        )
