...
public val GradesGroup.Box4Outline: ImageVector
    get() {
        if (_box4Outline != null) {
            return _box4Outline!!
        }
        _box4Outline = Builder(name = "Box4Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box4Outline: ImageVector? = null
