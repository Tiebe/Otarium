...
public val GradesGroup.Box3Outline: ImageVector
    get() {
        if (_box3Outline != null) {
            return _box3Outline!!
        }
        _box3Outline = Builder(name = "Box3Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box3Outline: ImageVector? = null
