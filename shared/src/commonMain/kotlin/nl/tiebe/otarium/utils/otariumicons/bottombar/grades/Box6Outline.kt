...
public val GradesGroup.Box6Outline: ImageVector
    get() {
        if (_box6Outline != null) {
            return _box6Outline!!
        }
        _box6Outline = Builder(name = "Box6Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box6Outline: ImageVector? = null
