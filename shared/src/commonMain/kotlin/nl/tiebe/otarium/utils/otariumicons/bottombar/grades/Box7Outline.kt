...
public val GradesGroup.Box7Outline: ImageVector
    get() {
        if (_box7Outline != null) {
            return _box7Outline!!
        }
        _box7Outline = Builder(name = "Box7Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box7Outline: ImageVector? = null
