...
public val GradesGroup.Box8Outline: ImageVector
    get() {
        if (_box8Outline != null) {
            return _box8Outline!!
        }
        _box8Outline = Builder(name = "Box8Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box8Outline: ImageVector? = null
