...
public val GradesGroup.Box5Filled: ImageVector
    get() {
        if (_box5Filled != null) {
            return _box5Filled!!
        }
        _box5Filled = Builder(name = "Box5Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box5Filled: ImageVector? = null
