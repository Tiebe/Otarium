...
public val GradesGroup.Box3Filled: ImageVector
    get() {
        if (_box3Filled != null) {
            return _box3Filled!!
        }
        _box3Filled = Builder(name = "Box3Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box3Filled: ImageVector? = null
