...
public val GradesGroup.Box8Filled: ImageVector
    get() {
        if (_box8Filled != null) {
            return _box8Filled!!
        }
        _box8Filled = Builder(name = "Box8Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box8Filled: ImageVector? = null
