...
public val GradesGroup.Box7Filled: ImageVector
    get() {
        if (_box7Filled != null) {
            return _box7Filled!!
        }
        _box7Filled = Builder(name = "Box7Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box7Filled: ImageVector? = null
