...
public val GradesGroup.Box2Filled: ImageVector
    get() {
        if (_box2Filled != null) {
            return _box2Filled!!
        }
        _box2Filled = Builder(name = "Box2Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box2Filled: ImageVector? = null
