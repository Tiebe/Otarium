...
public val GradesGroup.Box9Filled: ImageVector
    get() {
        if (_box9Filled != null) {
            return _box9Filled!!
        }
        _box9Filled = Builder(name = "Box9Filled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _box9Filled: ImageVector? = null
