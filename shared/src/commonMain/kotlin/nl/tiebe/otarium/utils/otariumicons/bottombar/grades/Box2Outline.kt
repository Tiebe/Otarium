...
public val GradesGroup.Box2Outline: ImageVector
    get() {
        if (_box2Outline != null) {
            return _box2Outline!!
        }
        _box2Outline = Builder(name = "Box2Outline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _box2Outline: ImageVector? = null
