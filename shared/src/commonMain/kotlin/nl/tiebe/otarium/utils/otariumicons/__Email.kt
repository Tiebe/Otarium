...
import nl.tiebe.otarium.utils.otariumicons.email.AllAssets
...
import nl.tiebe.otarium.utils.otariumicons.email.RichTextEditor
...
public val EmailGroup.AllAssets: ____KtList<ImageVector>
  get() {
    ...
    __AllAssets= RichTextEditor.AllAssets + listOf(Attachment, AttachmentOff, Delete, DeleteRestore,
        EmailAlert, EmailAlertOpen, EmailOpen, Folder, FolderSwap, Inbox, Pencil, Reply, Send,
        Share)
    return __AllAssets!!
  }
