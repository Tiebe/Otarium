package nl.tiebe.otarium.ui.icons
...
val NotificationIcon: ImageVector
    get() {
        if (_icNotificationForeground != null) {
            return _icNotificationForeground!!
        }
        _icNotificationForeground = Builder(name = "IcNotificationForeground", defaultWidth =
                108.0.dp, defaultHeight = 108.0.dp, viewportWidth = 108.0f, viewportHeight =
                108.0f).apply {
            group {
...
private var _icNotificationForeground: ImageVector? = null
