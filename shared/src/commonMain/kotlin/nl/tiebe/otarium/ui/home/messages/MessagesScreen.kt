...
internal fun MessagesFolderSelectScreen(component: MessagesComponent) {
    ...
    val refreshState = rememberPullRefreshState(refreshing = component.refreshState.value, onRefresh = component::getFolders)
    ...
    Box(modifier = Modifier.pullRefresh(refreshState)) {
        ...
        PullRefreshIndicator(component.refreshState.value, refreshState)
    }
}